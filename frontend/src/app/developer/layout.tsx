...
const menuItems = [
  { name: 'Dashboard', href: '/developer/dashboard', icon: '📊' },
  { name: 'My Bookings', href: '/developer/bookings', icon: '📅' },
  { name: 'Earnings', href: '/developer/earnings', icon: '💰' },
  { name: 'Support', href: '/developer/tickets', icon: '🎫' },
];
